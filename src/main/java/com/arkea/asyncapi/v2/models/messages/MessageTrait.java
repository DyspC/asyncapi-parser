...
/**
 * @see "https://github.com/asyncapi/asyncapi/blob/master/versions/2.0.0/asyncapi.md#messageTraitObject"
 */
public class MessageTrait implements Referenceable {
    ...
    public void setBindings(final Map<String, MessageBinding> map) {
        this.bindings = map;
    }
    ...
    public void set$ref(String $ref) {
        if ($ref != null && $ref.indexOf('.') == -1 && $ref.indexOf('/') == -1) {
            $ref = "#/components/messages/messageTraits/" + $ref;
        }
        this.$ref = $ref;
    }

    public MessageTrait $ref(final String $ref) {
    ...
    public boolean equals(final Object obj) {
        ...
        final MessageTrait other = (MessageTrait) obj;
        if (this.$ref == null) {
            if (other.$ref != null) {
                return false;
            }
    ...
    public String toString() {
        return "MessageTrait [headers=" + this.headers + ", correlationId=" + this.correlationId + ", schemaFormat=" + this.schemaFormat + ", contentType=" + this.contentType + ", name=" + this.name + ", title=" + this.title + ", summary=" + this.summary + ", description=" + this.description
                        + ", tags=" + this.tags + ", externalDocs="
                        + this.externalDocs + ", bindings=" + this.bindings + ", $ref=" + this.$ref + ", extensions=" + this.extensions + "]";
    }
